...
public class MainActivity extends AppCompatActivity {
    ...
    private void setButtonColors() {
        ...
        for (int buttonIndex = 0; buttonIndex < mLightGrid.getChildCount(); buttonIndex++) {
            ...
            if (mGame.isLightOn(row, col)) {
                ...
                gridButton.setContentDescription(getString(R.string.lightOnDescription));
            } else {
                gridButton.setBackgroundColor(mLightOffColor);
                gridButton.setContentDescription(getString(R.string.lightOffDescription));
            }
        }
    }
    ...
    // An activity result launcher to send back selected color to main
